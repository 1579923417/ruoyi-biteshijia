...
public class AppUserMinerController extends BaseController {
    ...
    @PreAuthorize("@ss.hasPermi('app:appUserMiner:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('app:appUserMiner:query')")
    @GetMapping("/{id}")
    public AjaxResult get(@PathVariable("id") Long id){
        return AjaxResult.success(appUserMinerService.selectById(id));
    }

    @PreAuthorize("@ss.hasPermi('app:appUserMiner:add')")
    ...
    @PreAuthorize("@ss.hasPermi('app:appUserMiner:edit')")
    ...
    @PreAuthorize("@ss.hasPermi('app:appUserMiner:remove')")
